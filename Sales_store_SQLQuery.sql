...
--Insert the data using BULK INSERT
SET DATEFORMAT dmy
BULK INSERT sales_store
FROM 'C:\Users\balay\Desktop\Devi\DA_Portfolio Project\sales_store.csv'
	WITH (
		FIRSTROW=2,
		FIELDTERMINATOR=',',
		ROWTERMINATOR='\n'
...
-- DATA CLEANING
-- 1. Exact copy of the data to new table
...
HAVING COUNT(transaction_id) > 1
	...
	--TXN855235
	--TXN981773
	-- Let's check this in another way with complete details
...
--Delete the duplicate records from the 4 transaction id's
...
WHERE Row_num =2
	...
	-- CHECK THE TABLE BEFORE DELETE 2,005 RECORDS. AFTER DELETE 2001 RECORDS AVAILABLE. 4 DUPLICATE ROWS WERE DELETED.
